...
public class InsertarFisico extends Worker {

    public InsertarFisico(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        String direccion = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/jbarbero004/WEB/Gympower/Subirfisico.php?";
        ...
        String parametros = "descripcion="+ desc +"&peso="+ peso +"&url="+ url +"&nombre="+ nombre;
        try {
